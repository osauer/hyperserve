...
// documented defaults in Config. Idle buckets are pruned during requests; the
// gate starts no cleanup goroutine. When the pool is full, existing clients
// keep their buckets and a new client receives 429 Too Many Requests. Quota
// rejections also return 429 with Retry-After and RateLimit-Reset derived from
// the token schedule.
//
